...
import BudgetsSummary from '@/components/finance/BudgetsSummary';
import UpcomingBills from '@/components/finance/UpcomingBills';
import { useCurrencyFormatter } from '@/hooks/useCurrencyFormatter';
import GoalsSummary from '@/components/finance/GoalsSummary';
import DebtsSummary from '@/components/finance/DebtsSummary';
import NetWorthSummary from '@/components/finance/NetWorthSummary';
...
import DynamicAIInsights from '@/components/ai/DynamicAIInsights';
...
import BalanceForecast from '@/components/finance/BalanceForecast';
