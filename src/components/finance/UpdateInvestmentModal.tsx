      ...
      <div className="glass-card rounded-xl shadow-2xl w-full max-w-sm p-0 border border-divider animate-scaleIn" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
            <div>
                ...
                <input type="number" step="0.01" value={currentValue} onWheel={e => (e.target as HTMLInputElement).blur()} onChange={e => setCurrentValue(e.target.value)} placeholder="0.00" className="input-base w-full rounded-lg py-2 px-3 no-spinner" required autoFocus />
            </div>
