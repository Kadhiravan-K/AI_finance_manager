...
interface SplitTransactionModalProps {
  ...
  onSave: (transactionId: string, splits: { personName: string; amount: number; contactId: string }[]) => void;
  onCancel: () => void;
...
export const SplitTransactionModal: React.FC<SplitTransactionModalProps> = ({ transaction, onSave, onCancel, items }) => {
  ...
  const handleSubmit = () => {
    ...
    const finalSplits = participants.map(p => ({ personName: p.personName, amount: p.amount, contactId: p.id }));
