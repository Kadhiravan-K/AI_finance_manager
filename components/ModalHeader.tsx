...
const ModalHeader: React.FC<ModalHeaderProps> = ({ title, onClose, onBack, icon }) => {
  return (
    <div className="p-4 border-b border-divider flex-shrink-0 flex items-center justify-between relative">
      ...
      <button onClick={onClose} className="p-2 -mr-2 text-secondary hover:text-primary hover:bg-subtle rounded-full transition-colors">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
