  ...
  return (
    <div className="p-4 mb-4 rounded-xl bg-yellow-900/50 border border-yellow-700/80 animate-fadeInUp">
      <div className="flex items-start gap-3">
        ...
        <div>
          <h3 className="font-bold text-yellow-300">Suspicious Message Detected</h3>
          <p className="text-sm text-yellow-300/80 mt-1">Our AI has flagged this message as potential spam. Please review it carefully.</p>
