...
const TransactionForm: React.FC<TransactionFormProps> = ({ text, setText, onSubmit, isLoading, isDisabled, disabledReason }) => {
    ...
    <div className="relative">
      <form onSubmit={handleSubmit} className="space-y-4">
        <textarea
          ...
          placeholder="e.g., Received ₹500 from John via UPI"
