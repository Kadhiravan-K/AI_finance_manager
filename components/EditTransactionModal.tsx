...
const EditTransactionModal: React.FC<EditTransactionModalProps> = ({ transaction, onSave, onCancel, accounts, categories }) => {
  ...
  const handleParentCategoryChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
      ...
      // If there are no subcategories, the parent itself is the category.
      // Otherwise, default to the first subcategory or none.
      setFormData(prev => ({
          ...prev,
