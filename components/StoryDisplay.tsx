    ...
    const widgetMap: Record<DashboardWidget['id'], React.ReactNode> = {
        ...
        charts: (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <CategoryPieChart title="Income Sources" transactions={transactions} categories={categories} type={TransactionType.INCOME} />
                <CategoryPieChart title="Expense Categories" transactions={transactions} categories={categories} type={TransactionType.EXPENSE} />
            </div>
        )
    };
