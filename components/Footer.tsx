    ...
    <footer className="absolute bottom-0 left-0 right-0 glass-card border-t border-slate-700/50 p-2 z-10 rounded-t-2xl sm:rounded-b-3xl">
      <div className="flex justify-around items-center h-16">
        ...
        <FooterNavButton 
          ...
          isActive={activeModal === 'goals'}
          label="Goals"
          icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0c-.454-.303-.977-.454-1.5-.454V12c0-1.657 1.343-3 3-3h9c1.657 0 3 1.343 3 3v3.546zM12 3v5.954m0 0a2.704 2.704 0 013 0 2.704 2.704 0 003 0 2.704 2.704 0 013 0 2.704 2.704 0 003 0 2.704 2.704 0 013 0 2.704 2.704 0 003 0" /></svg>}
        />
        <FooterNavButton 
        ...
        <FooterNavButton 
          ...
          isActive={['settings', 'appSettings', 'categories', 'payees', 'export', 'senderManager'].includes(activeModal || '')}
          label="Settings"
